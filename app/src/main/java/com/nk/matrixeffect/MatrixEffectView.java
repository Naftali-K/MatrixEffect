...
/*
made by video from YouTube: https://youtu.be/25AUSTtob6g
 */
...
public class MatrixEffectView extends View {
    ...
    private int fontSize = 40; // font size, not change characters size.
    ...
    public MatrixEffectView(Context context, AttributeSet attrs){
        ...
        paintTxt.setTextSize(40); // characters size. best way put like value "fontSize"
